...
/** Full-page line-art scenes (owner-supplied reference designs, July 2026):
 *  flood-fill colouring rather than authored polygons - see assets/images/
 *  scene-*.svg (generated by assets/generate-colouring-scenes.mjs). */
const lineArtScenes: Activity[] = [
  {
    ...
    mode: 'line-art', image: 'images/scene-solar-system.svg', regions: [],
  },
  {
    type: 'colouring', id: 'colour-rocket-space', title: 'Rocket in Space', category: 'colouring',
    ageBands: ['3-5', '5-7'], difficulty: 2, motorSkills: ['tapping', 'precision-placement'],
    estimatedMinutes: 5, theme: 'space', locale: 'en-AU', instructionAudio: audio('colour-free'),
    mode: 'line-art', image: 'images/scene-rocket-space.svg', regions: [],
  },
  {
    ...
    mode: 'line-art', image: 'images/scene-unicorn-rainbow.svg', regions: [],
  },
  {
    ...
    mode: 'line-art', image: 'images/scene-monkey-tree.svg', regions: [],
  },
  {
    type: 'colouring', id: 'colour-rabbit-carrot', title: 'Rabbit with a Carrot', category: 'colouring',
    ageBands: ['2-3', '3-5', '5-7'], difficulty: 1, motorSkills: ['tapping'],
    estimatedMinutes: 5, theme: 'animals', locale: 'en-AU', instructionAudio: audio('colour-free'),
    mode: 'line-art', image: 'images/scene-rabbit-carrot.svg', regions: [],
  },
];
