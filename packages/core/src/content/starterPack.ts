...
const games: GameSpec[] = [
  ...
  // Sort in order (owner growth-stage art): drag the shuffled life-cycle cards
  // into the numbered boxes 1->4 in the right order. `ordered: true` + a `stages`
  // array (image refs already in the correct sequence) drives the renderer.
  { id: 'sort-order-frog', title: 'Frog life cycle', template: 'drag-sort', category: 'toddler', ageBands: ['3-5', '5-7'], difficulty: 2, motorSkills: ['dragging', 'precision-placement'], minutes: 2, theme: 'animals', params: { ordered: true, bins: ['1', '2', '3', '4'], stages: ['images/sort-frog-1.png', 'images/sort-frog-2.png', 'images/sort-frog-3.png', 'images/sort-frog-4.png'] } },
  { id: 'sort-order-sunflower', title: 'How a sunflower grows', template: 'drag-sort', category: 'toddler', ageBands: ['3-5', '5-7'], difficulty: 2, motorSkills: ['dragging', 'precision-placement'], minutes: 2, theme: 'nature', params: { ordered: true, bins: ['1', '2', '3', '4'], stages: ['images/sort-sunflower-1.png', 'images/sort-sunflower-2.png', 'images/sort-sunflower-3.png', 'images/sort-sunflower-4.png'] } },
  { id: 'sort-order-acorn', title: 'From acorn to tree', template: 'drag-sort', category: 'toddler', ageBands: ['3-5', '5-7'], difficulty: 3, motorSkills: ['dragging', 'precision-placement'], minutes: 2, theme: 'nature', params: { ordered: true, bins: ['1', '2', '3', '4'], stages: ['images/sort-acorn-1.png', 'images/sort-acorn-2.png', 'images/sort-acorn-3.png', 'images/sort-acorn-4.png'] } },
  { id: 'sort-order-butterfly', title: 'Butterfly life cycle', template: 'drag-sort', category: 'toddler', ageBands: ['3-5', '5-7'], difficulty: 3, motorSkills: ['dragging', 'precision-placement'], minutes: 2, theme: 'animals', params: { ordered: true, bins: ['1', '2', '3', '4'], stages: ['images/sort-butterfly-1.png', 'images/sort-butterfly-2.png', 'images/sort-butterfly-3.png', 'images/sort-butterfly-4.png'] } },
  // Memory Windows (owner window art): every card is a closed door; tap to open
  // it and reveal a character, match two of the same. `door` is the shared
  // closed-door image; `images` are the character "open" images (plain asset keys).
  { id: 'mem-friends-easy', title: 'Peekaboo windows — friends', template: 'memory-cards', category: 'toddler', ageBands: ['2-3', '3-5'], difficulty: 1, motorSkills: ['tapping'], minutes: 3, theme: 'animals', params: { door: 'mem-door-peach', pairs: 3, images: ['mem-sun', 'mem-apple', 'mem-butterfly', 'mem-whale', 'mem-turtle', 'mem-rocket'] } },
  { id: 'mem-friends', title: 'Peekaboo windows — more friends', template: 'memory-cards', category: 'toddler', ageBands: ['3-5', '5-7'], difficulty: 2, motorSkills: ['tapping'], minutes: 4, theme: 'animals', params: { door: 'mem-door-peach', pairs: 6, images: ['mem-sun', 'mem-apple', 'mem-butterfly', 'mem-whale', 'mem-turtle', 'mem-rocket'] } },
  { id: 'mem-sea-easy', title: 'Peekaboo windows — the sea', template: 'memory-cards', category: 'toddler', ageBands: ['2-3', '3-5'], difficulty: 1, motorSkills: ['tapping'], minutes: 3, theme: 'animals', params: { door: 'mem-door-peach', pairs: 3, images: ['mem-dolphin', 'mem-octopus', 'mem-seahorse', 'mem-starfish', 'mem-crab', 'mem-shark'] } },
  { id: 'mem-sea', title: 'Peekaboo windows — under the sea', template: 'memory-cards', category: 'toddler', ageBands: ['3-5', '5-7'], difficulty: 2, motorSkills: ['tapping'], minutes: 4, theme: 'animals', params: { door: 'mem-door-peach', pairs: 6, images: ['mem-dolphin', 'mem-octopus', 'mem-seahorse', 'mem-starfish', 'mem-crab', 'mem-shark'] } },
  { id: 'mem-aussie-easy', title: 'Peekaboo windows — Aussie animals', template: 'memory-cards', category: 'toddler', ageBands: ['2-3', '3-5'], difficulty: 1, motorSkills: ['tapping'], minutes: 3, theme: 'animals', params: { door: 'mem-door-aussie', pairs: 3, images: ['mem-koala', 'mem-kangaroo', 'mem-wombat', 'mem-platypus', 'mem-echidna', 'mem-quokka'] } },
  { id: 'mem-aussie', title: 'Peekaboo windows — more Aussie animals', template: 'memory-cards', category: 'toddler', ageBands: ['3-5', '5-7'], difficulty: 2, motorSkills: ['tapping'], minutes: 4, theme: 'animals', params: { door: 'mem-door-aussie', pairs: 6, images: ['mem-koala', 'mem-kangaroo', 'mem-wombat', 'mem-platypus', 'mem-echidna', 'mem-quokka'] } },
