...
const UPPER: Record<string, Point[][]> = {
  ...
  // Round letters (school way, owner direction): start at about 2 o'clock (top-
  // right), NOT the top, and curve anticlockwise ("c, then close") all the way
  // around, so the bottom is traced left-to-right.
  O: [arc(500, 500, 300, -35, -395, 26)],
  P: [line(330, 180, 330, 820), join(line(330, 200, 520, 200, 2), arc(520, 360, 160, -90, 90), line(520, 520, 330, 520, 2))],
  Q: [arc(500, 500, 290, -35, -395, 26), line(600, 630, 770, 820, 3)],
  R: [
...
const DIGITS: Record<string, Point[][]> = {
  // Tall, narrow oval so the digit reads as 0, not the letter O. Starts at
  // ~2 o'clock, anticlockwise (school way, matching the letter O).
  '0': [oval(500, 500, 200, 300, -35, -395, 30)],
