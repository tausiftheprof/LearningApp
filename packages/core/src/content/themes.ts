...
const storybook: AppTheme = {
  ...
  surface: '#FFFFFF',
  accent: '#9C8FD0',
  greeting: { background: '#DDD5F7', subtitle: 'Ready for some fun?', mascot: '🧸', mascotImage: 'mascot' },
  starPill: '#FFFFFF',
...
const aussie: AppTheme = {
  ...
  surface: '#FFFFFF',
  accent: '#567568',
  greeting: { background: '#CFE8D6', subtitle: "Let's explore and play!", mascot: '🐨', mascotImage: 'mascot' },
  starPill: '#FBE7A2',
